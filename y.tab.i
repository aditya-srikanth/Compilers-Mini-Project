...
# 271 "parser.y"
            ...
            int pos_of_field = 0;
            for(int i = 0; i < schema.length; i++){
              if(strcpy((yyvsp[-2].string),schema.schema_definition[i].name.field_name) == 0){
                pos_of_field = i;
                break;
              }
            }
...
# 280 "parser.y"
              ...
              if( strcmp((yyvsp[-1].condtional_operator).string,"=") == 0){
...
# 608 "parser.y"
                                ...
                                mkdir("./master",
# 612 "parser.y" 3 4
                                                  (0400|0200|(0400 >> 3)|(0200 >> 3)|((0400 >> 3) >> 3)|((0200 >> 3) >> 3))
# 612 "parser.y"
                                                             );
                                mkdir("./data",
# 613 "parser.y" 3 4
